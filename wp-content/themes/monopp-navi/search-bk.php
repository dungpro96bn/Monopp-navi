                    ...
                    <div class="sort-by">
                        <form method="get" action="<?php echo esc_url(home_url('/')); ?>">
                            ...
                            <select name="sorter" id="sorter" onchange="this.form.submit()">
                                <option value="meta_value_num" <?php selected($sort_by, 'meta_value_num'); ?>>Views</option>
            ...
            <?php else: ?>
                ...
                if ($post_ids) :?>
                    ...
                    $args = [
                        ...
                        'orderby' => $orderby,
                        'order' => $order,
                        'meta_key' => $meta_key, // Thêm meta_key nếu sắp xếp theo meta_value_num
                        'posts_per_page' => -1,
                    ];
